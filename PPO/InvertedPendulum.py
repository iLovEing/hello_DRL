...
def test():
    if False:
    # if True:
        play_video(ckpt=os.path.join('ckpt', 'InvertedPendulum-v5_episode_267_reward_962.pth'))
    else:
        save_video(ckpt=os.path.join('ckpt', 'InvertedPendulum-v5_episode_267_reward_962.pth'))
